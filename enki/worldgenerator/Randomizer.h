...
namespace Enki
{
	...
	private:
		...
		Also the default_randome_engine behavior isn't fixed a it directly depends on the implementation of the libstdc++ which can change depending on the OS.
	...
	public:
		...
		*/
		Randomizer(World* w, const long long int &seed=-1);
		...
		*/
		Randomizer(const long long int &seed = -1);
		...
		*/
		...
		/*!
			\brief This function generates a World::GroundTexture.
			\param width the texture width
			\param height the texture height
			\return the generated GroundTexture.
		*/
		World::GroundTexture randGroundTexture(float width, float height);
